---
name: pa-guyouquan-query
description: 查询"股友圈"社区数据，覆盖 3 类场景：搜索相关圈子、查看圈子热点内容、查看圈子热门持仓股票。当用户询问"股友圈有哪些半导体圈子"、"某板块/概念有哪些热门圈子"、"XX圈子里在讨论什么"、"这个圈子热门持仓股票有哪些"、"XX圈子大家都在买什么"等与股友圈社区相关的问题时，使用此 skill 获取实时数据，不要依赖训练知识编造圈子名称、帖子内容或持仓数据。用户提到"股友圈"、"圈子"、"社区热点"等字眼时，也应主动触发。
---
