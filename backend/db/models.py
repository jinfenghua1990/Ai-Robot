...
class HorsebackRun(Base):
    ...
    live_rise_pct_min = Column(Float, nullable=False, default=3.0)
    live_volume_ratio_min = Column(Float, nullable=False, default=1.2)
    allow_gem = Column(Boolean, nullable=False, default=False)
    allow_star = Column(Boolean, nullable=False, default=False)
