...
const ReportsPage = lazy(() => import('./research/ResearchReportsPage'));
const NotesPage = lazy(() => import('./research/ResearchNotesPage'));

const TABS = [
  { key: 'reports', label: '我的研报', icon: '📄', path: '/research/reports', Component: ReportsPage },
  { key: 'notes', label: '研究记录', icon: '📝', path: '/research/notes', Component: NotesPage },
];
