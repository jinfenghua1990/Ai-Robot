...
const SectorsPage = lazy(() => import('./research/ResearchSectorsPage'));
const RadarPage = lazy(() => import('./research/ResearchRadarPage'));

const TABS = [
  { key: 'sectors', label: '板块中心', icon: '🔲', path: '/research/sectors', Component: SectorsPage },
  { key: 'radar', label: '细分板块', icon: '🧩', path: '/research/radar', Component: RadarPage },
];

export default function SectorResearchHub() {
